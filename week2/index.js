...
// 請文字解釋為什麼
console.log(k * l > 21);
// k*l，會被強行轉為Number 3*'8'=24，24大於21為正確。結果為 true
...
} else if (coachIncome >= 100000 && coachIncome < 3000000) {
...
if (playerA === "剪刀") {
  ...
  if (playerB === "石頭") {
    console.log("playerB 玩家獲勝");
  }
  if (playerB === "布") {
    console.log("playerA 玩家獲勝");
  }
}
if (playerA === "石頭") {
  if (playerB === "石頭") {
...
coachObj = performanceData.coaches[0];
if (coachObj.name === "Alice") {
  // 請填寫第一位教練業績增長程式碼，使用 +=
  coachObj.performance += 8000;
}

// 練習：第二位教練（可將下方程式碼註解移除，完成答題）
coachObj = performanceData.coaches[1];
if (coachObj.name === "Bob") {
  // 請填寫第二位教練業績增長程式碼，使用 +=
  coachObj.performance += 12000;
}
